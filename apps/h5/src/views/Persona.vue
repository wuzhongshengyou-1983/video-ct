  ...
  <div class="page">
    ...
    <div v-if="!loading && !networkError && !persona" class="scan-section">
      ...
      <div class="vct-card archetypes-card">
        ...
        <div class="archetype-grid">
          <div v-for="a in archetypes" :key="a.name" class="archetype-item">
    ...
    <template v-if="persona">
      ...
      <section v-if="persona.findings?.length" class="vct-card">
        ...
        <div v-for="(f, i) in persona.findings" :key="i" class="finding-item">
          <div class="finding-dim">
            <span class="vct-tag">{{ f.dimension || "综合" }}</span>
          </div>
      ...
      <section v-if="persona.suggestions?.length" class="vct-card">
        ...
        <div
          v-for="(s, i) in persona.suggestions"
          :key="i"
          class="suggest-item"
        >
...
async function fetchData() {
  ...
  try {
    ...
    archetypes.value = a?.length ? a : [...PERSONA_ARCHETYPES];
  } catch (e: any) {
    if (!navigator.onLine) {
