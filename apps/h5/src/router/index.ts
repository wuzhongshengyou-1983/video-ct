...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    meta: { showTabbar: true, title: "诊断" },
  },
  {
    path: "/diagnose/submit",
    component: () => import("@/views/DiagnoseSubmit.vue"),
    meta: { title: "提交视频" },
  },
  {
    path: "/diagnose/resubmit/:id",
    component: () => import("@/views/DiagnoseResubmit.vue"),
    meta: { title: "复诊" },
  },
  {
    path: "/diagnose/:id",
    component: () => import("@/views/DiagnoseDetail.vue"),
    meta: { title: "诊断中" },
  },
  {
    path: "/report/:id",
